...
const navLinks = [
  ...
  { 
    ...
    subLinks: [
      ...
      { label: 'Intimate', path: '/shop?category=intimate' },
      { label: 'Kids Care', path: '/shop?category=kids care' },
      { label: 'Oral Care', path: '/shop?category=oral care' },
      { label: 'Muscles & Joints', path: '/shop?category=muscles & joints' },
      { label: 'Antiseptics', path: '/shop?category=antiseptics' },
      { label: 'Anti Scar', path: '/shop?category=anti scar' },
    ]
  },
  { 
    ...
    path: '/shop',
    subLinks: [
      { label: 'Vitamins', path: '/shop?category=vitamins' },
      { label: 'Supplements', path: '/shop?category=supplements' },
      { label: 'Wellness', path: '/shop?category=wellness' },
    ]
  },
