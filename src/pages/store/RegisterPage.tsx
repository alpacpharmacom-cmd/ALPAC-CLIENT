...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to ALPAC');
      navigate('/');
    } catch (error: any) {
  ...
  if (isLoading) return <FormSkeleton fields={5} titleWidth="60%" />;
            ...
            >
              ...
              <MotionBox variants={itemVariants}>
                <Button
                  ...
                  variant="contained"
                  disabled={isLoading}
                  endIcon={!isLoading ? <PersonAdd /> : undefined}
                  sx={{
              ...
              <MotionBox variants={itemVariants}>
                <Divider sx={{ my: 4, opacity: 1 }}>
                  <Typography sx={{ color: 'gray', fontSize: '0.9rem', fontWeight: 500}}>
                    or
                  </Typography>
                </Divider>
              </MotionBox>
